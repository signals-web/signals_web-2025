...
const Footnote = ({ number, text }: { number: number, text: string }) => {
  return (
    <span className="relative group">
      ...
      <span className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-64 bg-signals-navy text-white text-sm p-2 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
        {text}
      </span>
    </span>
  )
  ...
  return (
    <PageLayout bgColor="bg-signals-gray" textColor="text-signals-navy" hoverClass="hover:text-signals-red">
      ...
      <div className="space-y-8 md:col-span-2">
        <p className="text-signals-navy text-lg md:text-[1.75rem] font-light leading-relaxed">
          Chris Grimley is a graphic designer and the founding principal at SIGNALS, where he creates visual systems that communicate with clarity and purpose. As an author and graphic designer, he has developed books on the legacy of urban renewal,<Footnote 
            number={1} 
            text="See 'Heroic: Concrete Architecture and the New Boston' (2015)"
          /> architecture and photography monographs, archival surveys, and exhibition catalogues
          <Footnote 
            number={2} 
            text="See 'Imagining the Modern: Architecture and Urbanism of the Pittsburgh Renaissance' (2019)"
          />.
        </p>
        <p className="text-signals-navy text-lg md:text-[1.75rem] font-light leading-relaxed">
        Known for their sophisticated typographic sensibility and ability to transform complex information into compelling visual narratives, the studio has implemented wayfinding and signage for Exhibit Columbus, MASS MoCA, Vassar College, Harvard University, the Massachusetts Institute of Technology, the deCordova Sculpture Park and Museum, and the iconic Boston City Hall
          <Footnote 
            number={3} 
            text="Once called the ugliest building in the world, as @heroicproject we have been essential in transforming opions about this beloved brute."
          />.
        </p>
        <p className="text-signals-navy text-lg md:text-[1.75rem] font-light leading-relaxed">
